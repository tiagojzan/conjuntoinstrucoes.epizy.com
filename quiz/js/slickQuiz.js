...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  '<i class="fa fa-1x far fa-check-square"></i> Conferir!',
            ...
            setupQuiz: function() {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<div class="' + questionCountClass + '">Questão <span class="current">' + count + '</span> de <span class="total">' + questionCount + '</span></div>');
